...
const TaskItem = ({title, description, completed, onEdit, onDelete, taskId}) => {
    ...
    return (
        <div className='w-full md:w-auto flex justify-between items-center bg-gray-100 rounded p-2 shadow-md mb-4'>
            <div className='flex justify-center items-center gap-2'>
                <div>
                    <input
                        ...
                        {...register(`tasks[${taskId}].completed`)}
            ...
            <div className='flex gap-2'>
                <button className='bg-red-500 px-2 py-1 rounded text-white' onClick={onDelete}>Delete</button>
                <button className='bg-blue-500 px-2 py-1 rounded text-white' onClick={onEdit}>Edit</button>
            </div>
        </div>
    )
}
